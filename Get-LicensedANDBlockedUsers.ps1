...
.EXAMPLE
   .\Get-LicensedANDBlockedUsers.ps1 -OutputFile <FullPath_to_save_the_output.csv>
.EXAMPLE
   .\Get-LicensedANDBlockedUsers.ps1 (if no parameters are entered, you will be prompted for them)
