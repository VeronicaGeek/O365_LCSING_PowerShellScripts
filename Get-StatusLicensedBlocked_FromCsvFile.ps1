...
.EXAMPLE
   .\Get-StatusLicensedBlocked_FromCsvFile.ps1 -TenantName <TenantName> -CsvFileLocation <CsvFile_Location>
.EXAMPLE
   .\Get-StatusLicensedBlocked_FromCsvFile.ps1 (if no parameters are entered, you will be prompted for them)
...
foreach ($user in $UsersList) 
    {
        ...
        $Results += (Get-MsolUser -UserPrincipalName $user.UserPrincipalName) | Select-Object UserPrincipalName,isLicensed,BlockCredential
    }
